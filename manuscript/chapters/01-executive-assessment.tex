...
The safest integrative assessment is stated at the outset: the case is partly resolved at the evidence level and unresolved at the explanatory level. This distinction governs the chapter summaries that follow.
...
The identity wording in this chapter follows the current source hierarchy. Modern reporting records a researcher/lab-led Webb attribution, while public reporting in July 2026 still described the SAPOL coronial investigation as ongoing and did not supply an acquired coroner, SAPOL, or Forensic Science SA determination in this repository \parencite{m11-m11-src-0001,m11-m11-src-0003}.
