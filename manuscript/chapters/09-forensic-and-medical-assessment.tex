...
This wording follows the inquest-source boundary recorded by State Records and the toxicology register: the result concerns submitted specimens and common poisons, not every possible toxic agent \parencite{src-src-0003,doc-doc-0001}.
...
The 2:00 a.m. timing is therefore an estimate derived from medical evidence and later coroner framing. It is not an observed time of death and should not be used to settle witness-continuity or place-of-death questions.
...
Current public reporting similarly treats modern work primarily as an identity process rather than a resolved cause-of-death process. That reporting is useful context, but it is not a substitute for an official forensic or coronial report \parencite{m11-m11-src-0001}.
