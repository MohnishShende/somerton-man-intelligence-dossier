...
State Records' public guide also notes a source-boundary issue: the Rubaiyat book, code, telephone number, and associated interview material entered the investigation after the 1949 inquest record and are not part of the coroner-file testimony in the same way as the inquest exhibits \parencite{src-src-0003}.
...
The custody counts are register findings. They do not deny object existence; they limit later claims about transfer, retention, destruction, re-examination, or present custodian status.
