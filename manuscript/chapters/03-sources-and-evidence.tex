...
\section{Historiography of the Case}

The Somerton Man case has a long interpretive history. This dossier treats that history as part of the research problem. Previous investigations, books, articles, broadcasts, researcher archives, DNA announcements, and teaching summaries may preserve useful leads or public interpretations, but they do not all carry the same evidentiary weight.

The original police and coronial investigations are primary evidentiary layers, but they are also historically situated processes. They reflect the investigative, medical, archival, and communication practices of 1948--1949. Their records are therefore high-value sources, not perfect or complete records. The 1949 coronial material is central because it gathers witness, police, medical, and administrative evidence, while later Rubaiyat, telephone-number, and related interview material requires separate source handling when it falls outside the coroner's file \parencite{src-src-0001,doc-doc-0001,src-src-0003}.

Gerry Feltus's work is treated as practitioner history and a major secondary source. His book is valuable because of his police background, access pathways, illustrations, chronology, appendices, and long engagement with the case \parencite{src-src-0018}. It is not used as a substitute for primary evidence where official records, page images, or contemporary documents are available. Claims drawn from Feltus should therefore be mapped to source records or retained as investigator interpretation.

Rowan Holmes's article is treated as academic historiography and a source of methodological caution. Holmes explicitly frames the case through microhistory and lacunae, and offers possible related-case connections without firm closure \parencite{src-src-0014}. This dossier can use that work to understand interpretive traditions and research leads, but it does not convert proposed relationships into case findings without independent support.

Derek Abbott occupies several distinct source roles. The Abbott-hosted primary-source archive is a practical pathway to public reproductions of inquest files, police extracts, charts, and images. Abbott's modern DNA and identity work is a separate researcher/laboratory-participant source stream. The manuscript therefore separates archive hosting, source discovery, public scientific claim, and official custodial confirmation \parencite{src-src-0005,m11-m11-src-0003,m11-m11-src-0009}.

Modern DNA and genetic-genealogy reporting marks a new phase in the case's historiography. It materially changes public discussion of identity, but it does not by itself close the identity question under this project's evidentiary standard. Until an official coroner, SAPOL, or Forensic Science SA record is acquired, the Webb attribution remains a researcher/lab-led identification lead.

Derivative summaries, podcasts, teaching packets, and public mystery narratives are handled as reception or source-discovery material. They may reveal how the case has been framed for public audiences, but they are not used to establish facts unless their claims can be traced to primary records, reliable scholarship, or official statements.
